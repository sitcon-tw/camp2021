export default {
  ...
  head: {
    title: 'SITCON 線上夏令營 2021 | SITCON Camp Online',
    htmlAttrs: {
      lang: 'zh-TW'
    },
    meta: [
      ...
      { property: 'og:title', content: 'SITCON 線上夏令營 2021 | SITCON Camp Online' },
      ...
      { property: 'twitter:title', content: 'SITCON 線上夏令營 2021 | SITCON Camp Online' },
