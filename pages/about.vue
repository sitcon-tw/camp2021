<template>
  <div class="container">
    ...
    <div class="img-content-container">
      <div class="content">
        ...
        <p>
          ...
          <br />
          <br />藉由舉辦多軌議程、議程、論壇的交流與討論，期望將資訊領域的知識與不同領域背景人才交換新知！
        </p>
      </div>
      <div class="img">
    ...
    <div class="img-content-container">
      ...
      <div class="img">
        <img src="/2021/img/50694221331_e465f84efc_k.jpg" />
      </div>
    </div>
    <div class="img-content-container">
      <div class="content">
        ...
        <p>
          ...
          <br />
          <br />透過主線課程、社群闖關、視界咖啡館、黑客松等活動，讓學員充分吸收新知、動手實作、尋找自己的愛好及興趣，進而加入我們一起推動 Open Source。
        </p>
      </div>
      <div class="img">
        <img src="/2021/img/sitcon.jpg" />
    ...
    <div class="img-content-container">
      ...
      <div class="img">
        <img src="/2021/img/49294271702_ec4bc17bce_k.jpg" />
      </div>
    </div>
